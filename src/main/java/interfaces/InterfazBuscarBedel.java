...
public class InterfazBuscarBedel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        campoApellido.setNextFocusableComponent(jCheckBox1);
        ...
        jCheckBox3.setNextFocusableComponent(jButton1);
        ...
        jButton4.setNextFocusableComponent(botonCancelar);

        botonCancelar.setBackground(new java.awt.Color(102, 0, 0));
        botonCancelar.setForeground(new java.awt.Color(255, 255, 255));
        botonCancelar.setText("Cancelar");
        botonCancelar.setNextFocusableComponent(campoApellido);
