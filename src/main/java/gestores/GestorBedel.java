...
public class GestorBedel {
    ...
    public void registrarBedel(BedelDTO bedelDTO) throws PoliticasContraseniaException, YaExisteUsuarioException, OperacionException {
    ...
    public List<BedelBusquedaDTO> buscarBedeles(BedelGeneralDTO bedelGeneralDTO) throws ErrorException {
        ...
        if(bedelGeneralDTO.getTurnos().isEmpty()) { // Si no se seleccionó ningún turno, buscamos todos
    ...
    public void modificarBedel(BedelDTO bedelDTO) throws PoliticasContraseniaException, OperacionException {
        ...
        bedelPostgreSQLDAO.modificarBedel(bedel);
    ...
    public void eliminarBedel(BedelBusquedaDTO bedelBusquedaDTO) throws OperacionException {
